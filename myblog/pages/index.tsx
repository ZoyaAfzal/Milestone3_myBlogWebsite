        ...
        <div  id="postSection" className="image-grid max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6 py-6 px-4">
          {
            posts.map((post)=>(
              ...
              <div className="border-[1px] border-secondaryColor border-opacity-40 h-[450px] group">
                ...
                <div className="flex justify-between items-center px-4 py-1 border-b-[1px] border-b-gray-500 font-bold">
                  <p>
                    {post.title}
                  </p>
                    <Image
                    ...
                    width={48}
                    height={48}
                    style={{width:48, height:48, objectFit: 'cover', borderRadius:100}}
                    >    
                    </Image>
                </div>
                 <p className="py-2 px-4 text-base">
                  {post.description.substring(0, 92)}... by -{" "} 
